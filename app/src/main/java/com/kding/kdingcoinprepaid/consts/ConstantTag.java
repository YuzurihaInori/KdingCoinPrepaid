...
public class ConstantTag {
     ...
     * for select org
     */
    public static final String USER_TYPE_PRESIDENT = "USER_TYPE_PRESIDENT";
    public static final String USER_TYPE_MEMBER = "USER_TYPE_MEMBER";

    public static final String SELECT_ORG_KEY = "SELECT_ORG_KEY";
    public static final String GAME_LIST_KEY = "GAME_LIST_KEY";
    public static final String UNION_LIST_KEY = "UNION_LIST_KEY";

    public static final int SELECT_REQUESTCODE = 201;
