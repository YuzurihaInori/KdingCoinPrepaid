...
public class TradeDetailActivity extends BaseCompatActivity implements IResultCallBack<TradeDetailBean>{
    ...
    private void initView() {
        ...
        tradeDetailAdapter = new TradeDetailAdapter(this);
    ...
    public void resultSuc(List<TradeDetailBean> result) {
        tradeDetailAdapter.addAll(result);
    }
